...
public class SparklrAdapter implements ApiAdapter<Sparklr> {
	...
	@Override
	public void setConnectionValues(Sparklr sparklr, ConnectionValues values) {
		SparklrProfile profile = sparklr.meOperations().getUserProfile();
	...
	@Override
	public boolean test(Sparklr sparklr) {
		try {
			sparklr.meOperations().getUserProfile();
			return true;
	...
	@Override
	public void updateStatus(Sparklr exFm, String arg1) {
