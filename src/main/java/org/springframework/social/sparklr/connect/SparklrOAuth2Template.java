...
/**
 * ExFm-specific extension of OAuth2Template
 * 
 * @author Michael Lavelle
 */
public class SparklrOAuth2Template extends OAuth2Template {

	private String clientSecret;

	public SparklrOAuth2Template(String clientId, String clientSecret,
